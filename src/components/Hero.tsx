  ...
  return (
    <section id="about" className="hero">
      <div className="hero__grid">
        ...
        {/* Purely decorative — balances the hero's empty right column on wide
            screens. Not content, so it's inert to assistive tech. */}
        <div className="hero__motif" aria-hidden="true">
          <span className="hero__motif-corner hero__motif-corner--tl" />
          <span className="hero__motif-corner hero__motif-corner--tr" />
          <span className="hero__motif-corner hero__motif-corner--bl" />
          <span className="hero__motif-corner hero__motif-corner--br" />
          <span className="hero__motif-field" />
          <span className="hero__motif-crosshair hero__motif-crosshair--h" />
          <span className="hero__motif-crosshair hero__motif-crosshair--v" />
          <span className="hero__motif-mark" />
        </div>
      </div>
    </section>
  )
