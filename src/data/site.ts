export const site = {
  ...
  heroBody:
    'UC Berkeley Data Science student with a minor in Industrial Engineering & Operations Research. I build applied AI and data tools, including a multi-agent urban planning system using six public datasets and a voice-driven automation pipeline for Meta Ray-Ban glasses.',
